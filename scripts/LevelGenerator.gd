...
var PlatformScene = {
	1 : preload("res://platform.tscn"),
	2 : preload("res://platform2.tscn"),
	3 : preload("res://platform3.tscn"),
	4 : preload("res://platform4.tscn"),
	5 : preload("res://platform5.tscn")
	}

var count_spawned_platform = 0
...
func create_platform(location: Vector3):
	...
	if count_spawned_platform > 7:
		count_spawned_platform = 0
		random_color = randi() % 5 + 1 
		
	var _platform = PlatformScene[random_color].instantiate()
